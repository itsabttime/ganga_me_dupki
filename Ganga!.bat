...
set final=
echo "!enterrfilepath!" | findstr /r "^!"&&GOTO EXCLAMATION
echo gathring th harvest.pleasewait........
PAUSE
(for /l %%i in (0,1,250) do set temp=!enterrfilepath:~%%i,1!&if "!temp!" NEQ "*" (set final=!final!!temp!) else (echo.ABOMINATIONS))&set enterrfilepath=!final!&set final=
(for /l %%i in (0,1,250) do set temp=!enterrfilepath:~%%i,1!&if "!temp!" NEQ "^" (set final=!final!!temp!) else (echo.ABOMINATIONS))&set enterrfilepath=!final!&set final=
(for /l %%i in (0,1,250) do set temp=!enterrfilepath:~%%i,1!&if "!temp!" NEQ ">" (set final=!final!!temp!) else (echo.ABOMINATIONS))&set enterrfilepath=!final!&set final=
(for /l %%i in (0,1,250) do set temp=!enterrfilepath:~%%i,1!&if "!temp!" NEQ "<" (set final=!final!!temp!) else (echo.ABOMINATIONS))&set enterrfilepath=!final!&set final=
(for /l %%i in (0,1,250) do set temp=!enterrfilepath:~%%i,1!&if "!temp!" NEQ "=" (set final=!final!!temp!) else (echo.ABOMINATIONS))&set enterrfilepath=!final!&set final=
(for /l %%i in (0,1,250) do set temp=!enterrfilepath:~%%i,1!&if "!temp!" NEQ "|" (set final=!final!!temp!) else (echo.ABOMINATIONS))
